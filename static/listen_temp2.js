const dialogue_sample = [
  ...
  "<span class ='red-text'>Suspect:</span> Okay, It was me. I have been robbing McDonald's each time I moved military bases. No one has been hurt… I just needed the money… Stop it, that’s all.",
];
let index = 0;
